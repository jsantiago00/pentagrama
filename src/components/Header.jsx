export default function Header({ title, onTitleChange, saved, theme, onToggleTheme, editMode, onToggleEditMode, onOpenDrumMachine, onOpenTuner, onOpenRhymeFinder }) {
  return (
